//
// Double.cpp for h in /home/elsamr_a/rendu/synthèse/abstractVM_2016/sources/Types
// 
// Made by Antoine El Samra
// Login   <elsamr_a@epitech.net>
// 
// Started on  Sun Jul 23 15:19:57 2017 Antoine El Samra
// Last update Wed Jul 26 12:37:17 2017 Antoine El Samra
//
...
IOperand *	Double::operator+(const IOperand &rhs) const
{
  ...
  if (rhs.getType() <= getType())
    {
      Double *	N = new(Double)(this->_strValue);
      try {
	std::stod(strNb);
      }
      catch (const std::out_of_range &orr) {
	throw(Exception("Invalide value"));
      ...
      N->setValue(this->_value + std::stod(strNb));
