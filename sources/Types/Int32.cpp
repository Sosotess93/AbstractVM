//
// Int32.cpp for t in /home/elsamr_a/rendu/synthèse/abstractVM_2016/sources/Types
// 
// Made by Antoine El Samra
// Login   <elsamr_a@epitech.net>
// 
// Started on  Sun Jul 23 15:10:16 2017 Antoine El Samra
// Last update Wed Jul 26 12:25:23 2017 Antoine El Samra
//
...
IOperand *	Int32::operator+(const IOperand &rhs) const
{
  ...
  if (rhs.getType() <= getType())
    {
      Int32 *	N = new(Int32)(this->_strValue);
      try {
	std::stoi(strNb);
      }
      catch (const std::out_of_range &orr) {
	throw(Exception("Invalide value"));
      ...
      N->setValue(this->_value + (int32_t)std::stoi(strNb));
